...
def nice_mean(nice,mean,name):
    ...
    while stop:
        ...
        if pick == "n":
            print("\nThe stranger gives you a high-five and walks away whistling happily...")
            nice = (nice + 1)
            stop = False
        if pick == "m":
            print("\nThe stranger mad-dogs you and kicks over a stool while leaving!")
            mean = (mean + 1)
            stop = False
